...
const zhCN = {
  ...
  providers: {
    ...
    authParamLabel: "参数名",
    enabledLabel: "启用",
    videoDialectLabel: "视频方言",
    extraTitle: "方言参数",
    extraHint: "按所选方言填写,例如 jimeng:region / service / req_key,runway:version,minimax:group_id。留空的键会被忽略。",
    extraKeyLabel: "键",
    extraValueLabel: "值",
    extraKeyPlaceholder: "region",
    extraValuePlaceholder: "cn-north-1",
    extraAddRow: "添加一行",
    akSkHelp: "Kling / Jimeng 的密钥值需填写 access_key:secret_key(在上面的「保存密钥」处保存)。",
    saveProvider: "保存服务商",
    currentTitle: "当前服务商",
    none: "未配置",
    ready: "就绪",
...
const enUS: typeof zhCN = {
  ...
  providers: {
    ...
    videoDialectLabel: "Video dialect",
    extraTitle: "Dialect params",
    extraHint:
      "Fill per the chosen dialect, e.g. jimeng: region / service / req_key, runway: version, minimax: group_id. Empty keys are ignored.",
    extraKeyLabel: "Key",
    extraValueLabel: "Value",
    extraKeyPlaceholder: "region",
    extraValuePlaceholder: "cn-north-1",
    extraAddRow: "Add a row",
    akSkHelp:
      "For Kling / Jimeng the secret value is access_key:secret_key (save it above under \"Save a key\").",
